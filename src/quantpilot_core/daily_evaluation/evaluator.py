...
NO_TRADE_TAXONOMY: Mapping[str, str] = {
    ...
    "insufficient_cash_for_one_lot": "insufficient_available_cash",
    "position_budget_below_one_lot": "less_than_one_valid_board_lot",
    "expected_edge_below_cost": "expected_edge_below_cost",
    "no_approved_candidate": "no_selected_candidates",
    "max_position_cap_reduction": "sizing_reduction",
    "dynamic_account_budget_reduction": "sizing_reduction",
    "small_account_one_lot_accommodation": "small_account_one_lot_accommodation",
    "board_lot_reduction": "sizing_reduction",
    "cash_reduction": "sizing_reduction",
    "missing_executable_buy_price": "invalid_execution_price",
    "buy_increment_missing_price": "invalid_execution_price",
    "buy_increment_suspended": "suspension",
    "buy_increment_not_permitted": "account_permission_denied",
    "buy_increment_unaffordable": "insufficient_available_cash",
