...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--decision-session", required=True)
...
def main() -> None:
    ...
    parameters = {"production_manifest_path": args.production_manifest, "decision_session": args.decision_session, "state_path": args.state_path, "report_path": args.report_path, "run_id": args.run_id, "dsn_env_var": args.dsn_env_var, "active_shadow": {"max_physical_model_calls_per_cycle": args.max_physical_model_calls, "max_estimated_cost_per_cycle": args.max_estimated_api_cost, "estimated_cost_per_call": args.estimated_cost_per_call}}
    continuous_paper_flow.serve(name="quantpilot-continuous-paper-v1", schedules=[Cron(args.cron, timezone=args.timezone)], parameters=parameters)
