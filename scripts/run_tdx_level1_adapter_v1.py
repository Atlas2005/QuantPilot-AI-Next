...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        payload = {
            ...
            "bar_count": 0,
            "callback_count": 0,
            "callback_parse_error_count": 0,
            "callback_dispatch_error_count": 0,
            "last_sanitized_callback_error": None,
            ...
            "sanitized_subscription_response": None,
            "polling_fallback_active": False,
            "unsubscribe_attempted": False,
            "unsubscribe_succeeded": False,
            "unsubscribe_error_type": None,
            "sanitized_unsubscribe_error": None,
            "shadow": bool(args.shadow),
            "error": str(exc),
        }
